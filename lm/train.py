...
def get_args():
    ...
    argparser.add_argument('--rnn_type', type=str, default='egrud_haste', choices=[e.value for e in RNNType])
...
def main(args):
    ...
    elif args.rnn_type == 'egrud_haste':
        model = LanguageModel(**model_args,
    ...
    return_bw_sparsity = True if model.rnn_type == 'egrud_haste' else False
